...
w3=unifrnd(lowerb,upperb,[l3_neurons l2_neurons]);%l2*l1
net3=zeros(l3_neurons,1);
o3=zeros(l3_neurons,1);
...
for i=1:max_epoch_p
  for j=1:num_of_train
      ...
      % Back Propagation
      f_driviate_e1= diag(h1.*(1-h1)); %n1*n1
      f_driviate_e2 = diag(h2.*(1-h2)); %n2*n2
      f_driviate_e3 = diag(h3.*(1-h3)); %n3*n3
      f_driviate= diag(o3.*(1-o3)); %l1*l1
